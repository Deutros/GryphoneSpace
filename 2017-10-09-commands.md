...
You can use regular expressions within a grep command. Regular expressions provide a powerful way to specify complex search patterns. Some of the characters that have a special meaning inside a regular expression are shown in Table 3-2. If you want a metacharacter to lose its special meaning and be taken literally, precede it by a blackslash (\).
