...
## Mail commands
This will mail the contents of the file to the mail adress with the subject.
{% highlight javascript %}
...
2. <a href="https://www.tecmint.com/how-to-check-disk-space-in-linux/" target="_blank">df commands examples</a>
